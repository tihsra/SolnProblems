...
public class Main{
	...
	public static void main(String[] args){
		...
		while(t-->0){
			...
			for(int i[] : color) inarr(i, scn);
			
			solve(n,m,k,tree,color);

		}

	}

	public static void solve(int n, int m, int k, int[] tree, int[][] color){

		ps(solver(n,m,k,tree,color));

	}

	public static int solver(int n, int m, int k, int[] tree, int[][] color){
